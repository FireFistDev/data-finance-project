    ...
    <div className="w-full py-16 text-white  ">
      <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3 px-4">
        <div className="lg:col-span-2 my-4">
          ...
          <p>sign up yo our newsletter and stay up to date.</p>
        </div>
        <div className="my-4">
          <div className="flex flex-col sm:flex-row items-center justify-between w-full">
            <input
              ...
              type="email"
              placeholder="Enter Emalil"
            />
            <button className="bg-[#00df9a] w-[200px] rounded-md font-medium ml-4 my-3  py-3 text-black">
              Notify Me
            </button>
          </div>
